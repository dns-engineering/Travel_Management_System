...
<head>
    ...
    <link href='<url id="cvbj42atuj34lvhnk2ng" type="url" status="failed" title="" wc="0">https://fonts.googleapis.com/icon?family=Material+Icons</url> ' rel='stylesheet'>
    <style>
        body {
    ...
    while ($row = mysqli_fetch_assoc($result)) { ?>
        <div class="holiday-card">
            ...
            <div class="holiday-details">
                ...
                <div class="row">
                    <div class="col">
                        <h4><i class="material-icons">Location:</i><?php echo $row['state']; ?></h4>
                        <h4><i class='material-icons'>Schedule:</i><?php echo $row['tourduration']; ?></h4>
                        
                    </div>
                    <div class="col">
                        <h4><i class="material-icons">Date:</i><?php echo $row['fromdate']; ?></h4>
                        <h4><i class="material-icons">Transportation:</i><?php echo $row['transportation']; ?></h4>
                    </div>
                </div>
