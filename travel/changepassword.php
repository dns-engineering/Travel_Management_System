...
<form class="login-form" action="changepass.php?email=<?php echo urlencode($email); ?>" method="POST">
    ...
    <div class="input-group">
        ...
        <div class="input-wrapper">
            <input id="oldPassword" type="password" name="oldPassword" placeholder="Enter your old password" required>
    ...
    <div class="input-group">
        ...
        <div class="input-wrapper">
            <input id="newPassword" type="password" name="newPassword" placeholder="Enter your new password" required>
            <i class="fa fa-lock"></i>
        </div>
    </div>
    ...
    <div class="input-group">
        ...
        <div class="input-wrapper">
            <input id="confirmPassword" type="password" name="confirmPassword" placeholder="Confirm your new password" required>
            <i class="fa fa-lock"></i>
        </div>
    </div>

    <button type="submit" class="submit-button">Change Password <i class="fa fa-arrow-right"></i></button>
