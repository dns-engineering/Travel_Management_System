...
<body>
    ...
    <div id="content">
        ...
        <div class="reviews-container">
            <input type="text" id="searchInput" onkeyup="searchTable()" placeholder="Search for review...">
            <table id="reviewTable">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn3">
                                <a href="deletereview.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this review?');">
                                    DELETE
                                </a>
                            </button>
                        </td>
    ...
    <script>
        function searchTable() {
            ...
            for (i = 0; i < tr.length; i++) {
                td = tr[i].getElementsByTagName("td")[2]; // Search by message content
                if (td) {
