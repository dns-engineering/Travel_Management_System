...
<body>
    ...
    <div id="content">
        ...
        <div class="global-container">
            <input type="text" id="searchInput" onkeyup="searchTable()" placeholder="Search for country name...">
            <table id="tourTable">
                <tr>
                    <th>ID</th>
                    <th>COUNTRY NAME</th>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="deletecountry.php?id=<?php echo $row['id']; ?>" class="btn" onclick="return confirm('Are you sure you want to delete this country?')">
                                Delete
                            </a>
                        </td>
                    </tr>
    ...
    <script>
        function searchTable() {
            ...
            for (i = 0; i < tr.length; i++) {
                td = tr[i].getElementsByTagName("td")[1]; // Change index according to country name column position
                if (td) {
