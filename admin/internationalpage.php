...
<body>
    ...
    <div id="content">
        <div class="header">
            ...
            <h1>International Tours Management</h1>
            ...
            <table id="tourTable">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <tr>
                        ...
                        <td><button class="btn1"><a href="updatepack.php?id=<?php echo $row['id']; ?>">UPDATE</a></button></td>
                        <td><button class="btn2"><a href="addimg.php?id=<?php echo $row['id']; ?>">UPDATE IMG</a></button></td>
                        <td><button class="btn3"><a href="deletepackage.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this package?');">DELETE</a></button></td>
                    </tr>
                    <?php
                }
                ?>
