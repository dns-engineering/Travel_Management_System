...
#sidebar .section-divider {
    ...
    margin-right: auto;
        ...
        .input-field:focus {
            border-color: #514caf;
            outline: none;
            box-shadow: 0 0 5px rgba(81, 76, 207, 0.5);
        }
...
<body>
    ...
    <div id="content">
        ...
        <div class="form-container">
            <h2>Add State</h2>
            <form action="addstate.php" method="post" enctype="multipart/form-data">
                <label for="state">State:</label><br>
                <input type="text" id="state" name="state" class="input-field" required><br>
                
                <label for="image">Image:</label><br>
                <input type="file" id="image" name="image" class="input-field" required><br>
