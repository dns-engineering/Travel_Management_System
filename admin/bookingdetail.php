...
$query = "SELECT * FROM book ORDER BY bookingdate DESC";
...
<body>
    ...
    <div id="content">
        ...
        <div class="container">
            <input type="text" id="searchInput" placeholder="Search for tour name...">
            <table>
                <tr>
                    <th>BOOK ID</th>
                    <th>USER NAME</th>
                ...
                <?php foreach ($rows as $row): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php else: ?>
                                <a href="confirm.php?id=<?php echo $row['id']; ?>" class="btn btn-confirm">CONFIRM</a>
                            <?php endif; ?>
                        </td>
                        <td>
                            <?php if ($row['status'] != 'pending'): ?>
                            ...
                            <?php else: ?>
                                <a href="deletebook.php?id=<?php echo $row['id']; ?>" class="btn btn-delete">DELETE</a>
