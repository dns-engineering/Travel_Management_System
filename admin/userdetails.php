            ...
            <table id="userTable">
                ...
                <?php while ($row = mysqli_fetch_assoc($result)): ?>
                    <tr>
                        ...
                        <td>
                            <button class="btn" onclick="return confirm('Are you sure you want to delete this user?')">
                                <a href="deleteuser.php?id=<?php echo $row['id']; ?>" style="color: white; text-decoration: none;">DELETE</a>
                            </button>
                        </td>
                    </tr>
                <?php endwhile; ?>
