...
$query = "SELECT * FROM hollydays WHERE tourtype='domestic'";
...
<head>
    ...
    <title>Domestic Tours Management</title>
...
#sidebar .section-divider {
    ...
    margin-right: auto;
        ...
        .btn2:hover {
            background-color: rgba(64, 0, 255, 0.705);
        }
            ...
            <table id="tourTable">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <tr>
                        ...
                        <td><a href="updatepack.php?id=<?php echo $row['id']; ?>" class="btn1">UPDATE</a></td>
                        <td><a href="addimg.php?id=<?php echo $row['id']; ?>" class="btn2">UPDATE IMG</a></td>
                        <td><a href="deletepackage.php?id=<?php echo $row['id']; ?>" class="btn3" onclick="return confirm('Are you sure you want to delete this package?')">DELETE</a></td>
                    </tr>
                    <?php
                }
                ?>
